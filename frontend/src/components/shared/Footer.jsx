      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-4 mt-4 md:mt-0">
            <Link to="https://facebook.com" className="hover:text-gray-400" aria-label="Facebook">
            ...
            <Link to="https://twitter.com" className="hover:text-gray-400" aria-label="Twitter">
            ...
            <Link to="https://linkedin.com" className="hover:text-gray-400" aria-label="LinkedIn">
